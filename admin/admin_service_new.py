...
from minha_practice import patients


class Admin:
    def __init__(self, file_path):
        self.file_path = os.path.join(os.path.dirname(__file__), '../repository/patients.txt')
...
file_path = os.path.join(os.path.dirname(__file__), '../repository/patients.txt')

# 파일 불러오기 예시
# if __name__ == "__main__":
#     admin = Admin('consultation\\patients.txt')  # 절대 경로 # txt 파일 경로 지정
